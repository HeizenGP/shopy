...
@section('title', 'Superadministrador')
@section('admin_heading', 'Bienvenido de nuevo, '.Auth::user()->name)
@section('admin_subheading', 'Estas son las estadísticas de hoy de tu tienda en línea')

@section('content')
<div class="space-y-7">
    <section class="grid gap-6 xl:grid-cols-3">
        <article class="rounded-[30px] bg-admin-sidebar p-7 text-white">
            <div class="flex items-start justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-lg font-black">Ventas totales</h2>
                        <p class="text-sm font-semibold text-white/45">{{ $stats['orders'] }} pedidos</p>
                    </div>
                </div>
            ...
            <div class="mt-5 flex items-center gap-8 text-sm font-black">
                ...
                <span>+{{ $stats['orders'] }} esta semana</span>
            </div>
        </article>
        ...
        <article class="rounded-[30px] bg-white p-7">
            <div class="flex items-start justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-lg font-black">Alertas de stock</h2>
                        <p class="text-sm font-semibold text-slate-400">{{ $stats['lowStock'] }} con stock bajo</p>
                    </div>
                </div>
    ...
    <section class="grid gap-6 xl:grid-cols-[1fr_246px]">
        <article class="rounded-[30px] bg-white p-7">
            <div class="mb-7 flex flex-wrap items-center justify-between gap-4">
                <h2 class="text-lg font-black text-slate-950">Rendimiento de ventas</h2>
                <div class="flex gap-3">
                    <button class="rounded-full border border-slate-200 px-5 py-2 text-xs font-bold text-slate-600">Exportar datos</button>
                    <button class="rounded-full border border-slate-200 px-5 py-2 text-xs font-bold text-slate-600">Últimos 14 días</button>
                </div>
            </div>
            ...
            <div class="relative h-72 overflow-hidden rounded-2xl">
                <svg viewBox="0 0 760 290" class="h-full w-full">
                    ...
                    <g fill="#aaa" font-size="12" font-weight="700">
                        <text x="40" y="275">03 Mié</text><text x="99" y="275">04 Jue</text><text x="158" y="275">05 Vie</text><text x="217" y="275">06 Sáb</text><text x="276" y="275">07 Dom</text><text x="335" y="275">08 Lun</text><text x="394" y="275">09 Mar</text><text x="453" y="275">10 Mié</text><text x="512" y="275">11 Jue</text><text x="571" y="275">12 Vie</text><text x="630" y="275">13 Sáb</text><text x="690" y="275">14 Dom</text>
                    </g>
                </svg>
            </div>
        </article>
        ...
        <article class="rounded-[30px] bg-white p-7">
            <h2 class="text-lg font-black text-slate-950">Categorías principales</h2>
            <div class="mx-auto mt-8 grid h-36 w-36 place-items-center rounded-full border-10 border-admin-sidebar border-l-slate-200 border-b-slate-200">
