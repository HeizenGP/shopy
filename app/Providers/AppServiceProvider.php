        ...
        try {
            if (Schema::hasTable('settings')) {
                ...
                config([
                    ...
                    'shop.colors_client.login_bg' => ShopHelper::getSetting('--color-client-login-bg'),
                    ...
                    'shop.colors_client.header_bg' => ShopHelper::getSetting('--color-client-header-bg'),
                    'shop.colors_client.footer_bg' => ShopHelper::getSetting('--color-client-footer-bg'),
                    ...
                    'shop.colors_admin.accent' => ShopHelper::getSetting('--color-admin-accent'),
                    'shop.colors_admin.login_bg' => ShopHelper::getSetting('--color-admin-login-bg'),
