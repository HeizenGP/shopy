    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden p-6 sm:p-8 lg:p-12 mb-12">
        <div class="lg:grid lg:grid-cols-2 lg:gap-x-12">
            ...
            <div class="mt-8 lg:mt-0 flex flex-col justify-between">
                <div>
                    <!-- Category & Title -->
                    <span class="text-xs font-bold uppercase tracking-wider text-client-primary">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    @foreach($product->variants as $variant)
                                        <button type="button" 
                                                ...
                                                :class="selectedVariantId === {{ $variant->id }} ? 'bg-client-primary border-client-primary text-white shadow-md shadow-client-primary/10' : 'bg-white border-slate-200 text-slate-700 hover:border-slate-300'"
                        ...
                        <div class="flex items-center gap-4 pt-4 border-t border-slate-100">
                            <div class="w-32">
                                ...
                                <select name="quantity" id="quantity" 
                                        class="w-full text-sm py-2 px-3 border border-slate-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-client-primary/20"
                                        :disabled="outOfStock">
                                    @for($i = 1; $i <= 10; $i++)
                            ...
                            <button type="submit" 
                                    ...
                                    :class="outOfStock ? 'bg-slate-300 border-slate-300 cursor-not-allowed' : 'bg-client-primary border-client-primary hover:bg-client-primary/90 shadow-client-primary/10'"
                                    :disabled="outOfStock"
                        ...
                        @guest
                            <div>
                                ...
                                <input type="text" name="name" id="reviewer_name" required 
                                       class="w-full text-sm px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-client-primary/20 bg-white">
                            </div>
                        @endguest
