        ...
        'branding' => [
            ...
            'fields' => [
                ...
                'color_theme_admin' => [
                    ...
                    'label' => 'Tema del Panel Administrativo & Login Admin',
                    'type' => 'select',
                    'default' => 'slate_corporate',
                    'rules' => 'required|string|in:custom,slate_corporate,emerald_night,monaco_lux,burgundy_prestige,sapphire_deep,nordic_charcoal',
                    'description' => 'Selecciona un tema de color elegante predefinido para el panel y su login. Elige "Personalizado" si deseas configurar cada color individualmente.',
                ],
                'color_theme_web' => [
                    'key' => 'color_theme_web',
                    'label' => 'Tema del Sitio Web & Login Cliente',
                    'type' => 'select',
                    'default' => 'indigo_imperial',
                    'rules' => 'required|string|in:custom,indigo_imperial,emerald_luxury,champagne_amber,burgundy_cream,nordic_teal,lavender_platinum',
                    'description' => 'Selecciona un tema de color elegante predefinido para la web del cliente y su login. Elige "Personalizado" si deseas configurar cada color individualmente.',
                ],
                'color_client_page' => [
