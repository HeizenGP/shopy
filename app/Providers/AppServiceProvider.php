        ...
        try {
            if (Schema::hasTable('settings')) {
                ...
                config([
                    ...
                    'shop.colors_client.surface' => $settings['--color-client-surface'] ?? config('shop.colors_client.surface'),
                    'shop.colors_client.surface_alt' => $settings['--color-client-surface-alt'] ?? config('shop.colors_client.surface_alt'),
                    'shop.colors_client.border' => $settings['--color-client-border'] ?? config('shop.colors_client.border'),
                    'shop.colors_client.text' => $settings['--color-client-text'] ?? config('shop.colors_client.text'),
                    'shop.colors_client.muted' => $settings['--color-client-muted'] ?? config('shop.colors_client.muted'),
                    'shop.colors_client.header_bg' => $settings['--color-client-header-bg'] ?? config('shop.colors_client.header_bg'),
                    'shop.colors_client.footer_bg' => $settings['--color-client-footer-bg'] ?? config('shop.colors_client.footer_bg'),
                    'shop.colors_client.card' => $settings['--color-client-card'] ?? config('shop.colors_client.card'),
                    'shop.colors_client.card_border' => $settings['--color-client-card-border'] ?? config('shop.colors_client.card_border'),
