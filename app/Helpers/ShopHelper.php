...
class ShopHelper
{
    ...
    private static function mapDatabaseKeyToConfigKey(string $key): ?string
    {
        $map = [
            ...
            '--color-client-border' => 'colors_client.border',
            '--color-client-text' => 'colors_client.text',
            '--color-client-muted' => 'colors_client.muted',
            '--color-client-header-bg' => 'colors_client.header_bg',
            '--color-client-footer-bg' => 'colors_client.footer_bg',
            '--color-client-card' => 'colors_client.card',
            '--color-client-card-border' => 'colors_client.card_border',
